...
export const EMPLOYEE_REFERRAL_REPORT_OIDC_AUDIENCE =
  "https://ta-ops-analytics-7ocrxwr7lq-uw.a.run.app"
export const EMPLOYEE_REFERRAL_REPORT_SCHEDULER_SERVICE_ACCOUNT =
  "ta-ops-ref-report-scheduler@turing-recruiting.iam.gserviceaccount.com"
export const EMPLOYEE_REFERRAL_WATCHDOG_SCHEDULER_SERVICE_ACCOUNT =
  "ta-ops-ref-watchdog-scheduler@turing-recruiting.iam.gserviceaccount.com"

const EMPLOYEE_REFERRAL_REPORT_SCHEDULER_SUBJECT = "115001180678439780883"
const EMPLOYEE_REFERRAL_WATCHDOG_SCHEDULER_SUBJECT = "110013280553213064813"
