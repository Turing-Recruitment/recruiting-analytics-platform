...
function referralLines(intent: NotificationIntent): string[] {
  ...
  // Candidate and requisition are separate labelled lines (Sam's spec). The old form packed
  ...
  // STAGE and RECRUITER lines removed per Sam 2026-08-06. Stage is invariably "Application
 ...
 *
 *  FAN-OUT (Sam 2026-08-06): a referral landing on a requisition is news for EVERY recruiter on
