...
// integration (RESEND_API_KEY, an @turing.com verified sender), reduced to the one call the drain
...
//   NOTIFY_EMAIL_FROM=...         (a verified sender, e.g. "TA Ops Alerts <ta-ops@turing.com>")
