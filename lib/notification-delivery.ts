...
export async function enqueuePending(): Promise<EnqueueResult> {
  ...
  for (const row of ledgerRows) {
    ...
    // FAN-OUT (Sam 2026-08-06). In recruiter mode a referral/agency alert goes to EVERY recruiter
 ...
 *  on the requisition.
 *
 *  RECRUITER MODE FAILS CLOSED WITHOUT A START LINE (Sam 2026-08-06: "They should ONLY receive
...
/** Per-channel escalation window in hours. Default referral 48h (the SLA, per Sam), agency 168h
