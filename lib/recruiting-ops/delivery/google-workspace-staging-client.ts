...
export const RECRUITING_OPS_GOOGLE_WRITER_SERVICE_ACCOUNT =
  "recops-sheets-writer@turing-recruiting.iam.gserviceaccount.com"
export const RECRUITING_OPS_ELT_DOC_OWNER = "eric@turing.com"
...
// because nothing had ever appended below the last hand-formatted row (CLO-130).
