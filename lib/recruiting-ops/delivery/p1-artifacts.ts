export const P1_ELT_DOC_TARGET = {
  ...
  // Per Sam's 2026-08-06 canonical-cutover directive, mutation authority
  ...
  stagingDocumentId: "1Yp0E7IgBbh800Wx8LAKsQk1X1qQ80bseDU70CTUMe7E",
  expectedTitle: "ELT Recruiting Updates",
  tabId: "t.0",
  liveFlag: "RECOPS_HYDRATE_ELT_DOC",
  // The retired Sam-owned copy is evidence-only now. It is an explicit deny
  // target even though this dry-run slice exposes no Google mutation method.
  deniedDocumentIds: ["1FKy--WUEPKOgCpVigjduOTcxp4X7EUYnn2NrHCIQA4o"],
} as const
