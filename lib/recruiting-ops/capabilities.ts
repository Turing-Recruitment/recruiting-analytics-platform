...
export const capabilityRegistry: readonly CapabilityRegistryRow[] = [
  {
    ...
    audiences: [
      {
        audience: "Sam, recruiting leadership, HODs",
        ...
        humanGate: "Sam reviews before stakeholder delivery; no live writes",
      },
    ],
    ...
    humanGates: ["Sam reviews before stakeholder delivery", "no live writes"],
  ...
  },
  {
    ...
    audiences: [
      {
        audience: "Recruiters, hiring managers, recruiting leads, Sam",
        ...
        humanGate: "Sam approves nudges/escalations",
      },
    ],
    ...
    humanGates: ["Sam approves nudges/escalations"],
  ...
  },
  {
    ...
    audiences: [
      {
        audience: "Sam, recruiter leads, leadership",
        ...
        humanGate: "Sam reviews stakeholder output",
      },
    ],
    ...
    humanGates: ["Sam reviews stakeholder output"],
  ...
  },
  {
    ...
    audiences: [
      {
        ...
        humanGate: "Sam approves reassignment proposals",
      },
    ],
    ...
    humanGates: ["Sam approves reassignment proposals"],
  ...
  },
  {
    ...
    audiences: [
      {
        audience: "Bob/CEO, executives, HODs, Sam",
        ...
        humanGate: "Sam reviews and finalizes; leadership-priority fields stay human-owned",
      },
      {
        ...
        humanGate: "Sam reviews the page before exec rollout; delivery beyond the authed page requires review",
      },
    ],
    ...
    humanGates: ["Sam reviews and finalizes", "leadership-priority fields human-owned", "exec page reviewed before rollout"],
  ...
  },
  {
    ...
    audiences: [
      {
        audience: "ELT, org heads, recruiter leads, Sam",
        ...
        piiPosture: "Aggregate and leadership-safe; candidate details excluded by default",
        humanGate: "Sam reviews and sends; human owns the story",
      },
    ],
    ...
    humanGates: ["Sam reviews and sends", "human owns the narrative"],
  ...
  },
  {
    ...
    audiences: [
      {
        audience: "Sam, RecOps owner, approved admins",
  ...
  },
  {
    ...
    audiences: [
      {
        audience: "Sam, RecOps/admin owners",
  ...
  },
  {
    ...
    audiences: [
      {
        audience: "Sam, systems owners, vendor owners",
        ...
        humanGate: "Sam or named owner resolves",
      },
    ],
    ...
    humanGates: ["Sam or named owner resolves"],
    evidenceRefs: ["T12", "T13", "T14", "power_bi", "ifour"],
    workflowIds: ["T12", "T13", "T14"],
    moduleIds: ["t12-rc-tracker-monitoring", "t13-power-bi-dashboard-monitoring", "t14-power-bi-rls-ifour-coordination"],
  },
  {
    ...
    humanGates: ["Sam signs replacement/retirement decisions", "exposed credentials flagged for rotation"],
    evidenceRefs: ["T10", "T16", "T17", "apps_script", "n8n", "mailgun"],
    workflowIds: ["T10", "T16", "T17"],
    moduleIds: ["t10-rahul-bora-daily-report", "t16-n8n-workflow-setup", "t17-apps-script-development"],
  },
  {
    ...
    audiences: [
      {
        ...
        humanGate: "Sam signs off closure",
      },
    ],
    ...
    humanGates: ["Sam signs off closure"],
