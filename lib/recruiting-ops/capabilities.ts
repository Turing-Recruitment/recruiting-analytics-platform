...
export const capabilityRegistry: readonly CapabilityRegistryRow[] = [
  ...
  },
  {
    ...
    audiences: [
      {
        ...
        deliverableIds: ["rane_borg_sheet", "n8n_custody_packet", "apps_script_asset_registry"],
    ...
    moduleIds: ["t10-rane-borg-daily-report", "t16-n8n-workflow-setup", "t17-apps-script-development"],
  },
  {
