...
export const legacyArtifactRegistry = [
  ...
  legacyPowerBiArtifact(
    "legacy_power_bi_rls_ifour_packet",
    "Legacy Power BI RLS and iFour coordination packet",
    ["T14"],
    ["power_bi_rls_matrix"]
  ),
  ...
  legacyHandoffReadinessArtifact(
    ...
    "Legacy Sam handoff readiness tracker",
    ["T20/T21"],
...
function legacyDormantReportArtifact(
  ...
  return {
    ...
    nextGate: "Keep dormant unless Sam explicitly requests resume and validates the preserved template.",
  }
}
  ...
  return {
    ...
    provenance: [
      ...
      artifactDecision("Registered as handoff-readiness evidence; signoff is represented as data, not as cutover."),
      {
        ...
        detail: "Capture final readiness checklist, required evidence, and Sam acceptance semantics before closeout.",
      },
    ],
    blockers: ["OPEN: capture final readiness checklist, required evidence, and Sam acceptance semantics."],
