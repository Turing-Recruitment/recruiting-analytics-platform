...
export const CORE_STAGE_ORDER: ReadonlyArray<{ coreStage: string; order: number }> = [
  ...
  { coreStage: "Turing Assessment", order: 6 },
...
export const stageTaxonomyConfigV1: readonly StageTaxonomyEntry[] = [
  ...
  { substage: "Assessment", coreStage: "Turing Assessment", stageOrder: 6 },
  { substage: "Turing Assessment", coreStage: "Turing Assessment", stageOrder: 6 },
  ...
  { substage: "R2 - Pronojit/Marawan Interview", coreStage: "Onsite Interviews", stageOrder: 7, divergent: true },
  { substage: "R3 - Daniel/Amar", coreStage: "Onsite Interviews", stageOrder: 7, divergent: true },
