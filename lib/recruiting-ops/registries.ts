...
export const sourceRegistry = [
  ...
  source("ifour", "iFour", "vendor", "manual", "vendor_managed", ["legacy_artifact"], ["T14"], "Vendor coordination evidence for Power BI/RLS workflows."),
...
export const workflowRegistry = [
  ...
  workflow("T20/T21", "Sam Handoff Preparation", "handoff", "transition", "P0", "capture_required", "Source package, SOP completeness ledger, human gate checklist, and readiness dashboard.", ["google_sheets", "google_docs"], [], ["handoff_readiness_dashboard"]),
...
export const outputContractRegistry = [
  ...
  output("handoff_readiness_dashboard", "Handoff Readiness Dashboard", ["T20/T21"], "local_registry", ["google_sheets", "google_docs"], ["Sam signoff"], ["SOP closure", "access coverage"]),
  ...
  output("exec_state_of_play_snapshot", "Exec State-of-Play Snapshot", ["E01"], "local_registry", ["greenhouse"], ["Sam reviews the page before exec rollout"], ["reason-bearing health on every row", "unclassified stages never finalists or advances", "org-wide offers window"]),
