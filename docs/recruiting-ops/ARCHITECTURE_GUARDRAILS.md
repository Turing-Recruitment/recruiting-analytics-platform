...
5. SQL, Looker/SQL Runner, Apps Script, Sheets, Docs, Power BI, n8n, Mailgun, Slack, Gmail, Google Admin, LinkedIn, and iFour are evidence, custody, compatibility, source, or delivery surfaces.
...
- Production writes require a later adapter gate, auth review, tests, rollback path, and Sam approval.
