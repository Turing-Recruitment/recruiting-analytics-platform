...
The Recruiting Ops Command Center is not just an operator review console. It is a capability-first automation control plane. Sam should define, monitor, and adjust automation boundaries, not review every routine deterministic deliverable forever.
