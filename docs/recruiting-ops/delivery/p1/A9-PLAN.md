...
Status: **approved and implemented** (Sam Vangelos, 2026-08-06, via A9 expanded-scope
approval — recorded as RECOPS-ELT-FACT-TABLE-BOUNDARY-v2 in `PREREQUISITES.md`,
superseding v1). Validation findings are on Linear CLO-99. This document is the
implementation contract.

## What changes for the reader

Each week the ELT Recruiting Updates doc (Sam-owned copy only) gains the three Role
...
Sam ruled in the 2026-08-05 handover that the PII boundary is not a gate for the
Sam-owned copy. This change supersedes v1 with a v2 record in the same file: same copy,
