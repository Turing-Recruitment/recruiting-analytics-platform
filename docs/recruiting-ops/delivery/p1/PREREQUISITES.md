...
| Recipient and PII boundary | The output contract is `internal_review_identifiers`. Permitted content is the hire-table row fields (Role, Dept., Priority, Candidate Name, Start Date) plus the Role Progress narrative tail's QTD/weekly offer-accepted candidate names, for the exact last-complete Friday-through-Thursday week. | **Explicit human approval required** | Obtain Sam's exact approval statement below before applying any write configuration or running a copy canary. No programmatic approval latch substitutes for it. |
| Exact ACL fence | The writer accepts exactly two permissions: Sam as owner and `recops-sheets-writer@turing-recruiting.iam.gserviceaccount.com` as writer. Permission pagination, any third permission, or any ACL change blocks. | Ready in code; live recheck required | Independently confirm the exact copy ACL immediately before the canary and again after settlement. |
...
expanded-scope approval (v2) supersedes for the Sam-owned copy. Do not act on
v1 alone.
...
> only to copy `1FKy--WUEPKOgCpVigjduOTcxp4X7EUYnn2NrHCIQA4o` / tab `t.0` /
> `elt_doc_top_week_facts` for the exact last-complete Fri-Thu week, visible
> only under the exact copy ACL (Sam owner +
> `recops-sheets-writer@turing-recruiting.iam.gserviceaccount.com` writer), with
...
> canonical `1Yp0E7IgBbh800Wx8LAKsQk1X1qQ80bseDU70CTUMe7E` remaining read-only
...
> `1FKy--WUEPKOgCpVigjduOTcxp4X7EUYnn2NrHCIQA4o` / tab `t.0` /
...
> week, visible only under the exact copy ACL (Sam owner +
> `recops-sheets-writer@turing-recruiting.iam.gserviceaccount.com` writer),
...
> `1Yp0E7IgBbh800Wx8LAKsQk1X1qQ80bseDU70CTUMe7E` remaining read-only until a
> separate artifact-specific promotion approval.
>
> — Sam Vangelos, 2026-08-06, via A9 expanded-scope approval
...
Per Sam's 2026-08-06 canonical-cutover directive, the mutation target for
every P1/P2/P3/P4/P5 delivery artifact — not only the ELT doc — moved from the
Sam-owned copy to the CANONICAL artifact. For the ELT doc specifically: the
write target is now canonical `1Yp0E7IgBbh800Wx8LAKsQk1X1qQ80bseDU70CTUMe7E`
(title "ELT Recruiting Updates"), and the retired copy
`1FKy--WUEPKOgCpVigjduOTcxp4X7EUYnn2NrHCIQA4o` is now the explicit deny target
...
REQUIRES owner `eric@turing.com` and writer
`recops-sheets-writer@turing-recruiting.iam.gserviceaccount.com` to be present
...
Canonical mutation targets (retired Sam-owned copy id in parentheses, now
denied/unreachable from every active mutation path):

| Artifact key | Canonical id (live target) | Retired copy id |
|---|---|---|
| elt_doc | `1Yp0E7IgBbh800Wx8LAKsQk1X1qQ80bseDU70CTUMe7E` | `1FKy--WUEPKOgCpVigjduOTcxp4X7EUYnn2NrHCIQA4o` |
| weekly_recruitment | `1MJbvs5xh89qh_0FTsNEN_cTdML57mFEAbLLOJNdmD_I` | `1rjq6EjsTO2UxM9JLJigBvRl2Ny8EsRvwhyWw7Y_5VCA` |
| weekly_progress | `17xg8CtSeWET-S7c1Xcoup7YJXCnn15p_O-IOmVQKuxs` | `1gg7yFrUoYjM14KlMq4y3Und81N6KwDcTdsoTn7m9Pqo` |
| all_hires | `1PDyEkAlMRSkSPgOFunVuGUFejnUwX1YG4kGlbnyHijM` | `1akHN14SE6BPHvYcHuOmMx1G8UWE5WObz2jJSeO9HXWs` |
| pipeline_890 | `1wTHFRUSOri_qTte5UYEmooTAsfu9kT2H6PCuKqB8v7I` | `1LbZZ9GSacGrZqhKisjfMSvps7yYPrTFLaCUScObdWz8` |
| pipeline_907 | `1g0hCK53tJ03FgxUNNK4lizh1vUgOMWJjTg0vGWF_7M8` | `1Za8KtxKZMIlZGb35VIfmU1UByXaThwJLRPkvCigrE48` |
| pipeline_1026_1027 | `1z8zVQYrf_zc0bqq_uV5-ywS1AuyTDzLDO_4HnU3-oEk` | `1c1hzvXlrI3DtPIyearpz9rC9xXcE0ipByy-pTcHxmpA` |
| pipeline_1118_1119 | `1awdYMTrgxBq70Z56eAJCo4w5ix-S4aqMyV6_t7s9wSM` | `1nbVSqVLy1Pim2sODQFsPvY_E4liQ7K35BH_8v-sf6o4` |
| final_offer | `18630K9pIfuqvIqLDN1ItC37pgs0SqZ-lmv9JQHU4uGo` | `13-lJ90ua80Ia3cx8aKSdrs9Yv-R4ukePLIXu7hlF7eU` |
| rps_tracking | `1FrZlJj96-yXVdZltN3TcfLy9K_m6i_tFfrBgQGSoZEY` | `1KvWJnCtnIDhRRWPxktbn90cCCtQMdg-5DnZhKLMPfLg` |
| delivery_roles_rps | `1j9teESHnERTm1mmq7jDiI7qyZ3ygnzvaCbtLXdkzC3M` | `1Ga274ix5MlkiNU_o_X0SrruKtobzgoVoxmux6JeYa0k` |
...
> — Sam Vangelos, 2026-08-06, canonical cutover directive.

**RECOPS-ELT-BACKFILL-WEEK-v1 — extends v3; the archive gains one governed
backfill path.** Per Sam's 2026-08-08 decision on CLO-129 (choosing built
...
rolls back to the proven preimage. The backfilled entry is unmarked, per Sam's
...
revisions recorded on CLO-129 are the compensating evidence.

> — Recorded 2026-08-11, CLO-129 build; both ELT AST fingerprint pins
