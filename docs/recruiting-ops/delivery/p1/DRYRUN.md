...
- Exact ACL: owner `sam.vangelos@turing.com` and writer
  `recops-sheets-writer@turing-recruiting.iam.gserviceaccount.com`, with no
  third permission
...
or run a copy canary until Sam explicitly approves the exact
