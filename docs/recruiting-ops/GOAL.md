...
`/Users/sam.vangelos/Projects/recruiting-tools/ta-ops-analytics-automation-control-plane-phase1-6`
...
- Treat SQL, Looker/SQL Runner output, Sheets, Apps Script, Docs, n8n, Mailgun, Power BI, Slack, Gmail, Google Admin, LinkedIn, and iFour as evidence, custody, compatibility, or delivery surfaces.
