...
- Legacy SQL, Looker/SQL Runner output, Sheets, Apps Script, Docs, Power BI, n8n, Mailgun, Slack, Gmail, Google Admin, LinkedIn, and iFour are evidence, custody, compatibility, source, or delivery surfaces.
...
7. Add production adapters, live persistence, retirement, and autonomy only after Sam approval.
...
- No legacy Sheet/Doc/App Script/n8n/Power BI retirement without export/capture, replacement or accepted deletion, rollback decision, and Sam signoff.
