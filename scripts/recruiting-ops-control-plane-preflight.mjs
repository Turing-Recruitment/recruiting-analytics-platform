...
const DEFAULT_GCLOUD = "/Users/sam.vangelos/google-cloud-sdk/bin/gcloud"
const DEFAULT_PROJECT = "turing-recruiting"
const DEFAULT_REGION = "us-west1"
const DEFAULT_ACCOUNT = "sam.vangelos@turing.com"
...
const PRIVATE_ORIGIN = "https://ta-ops-staging-hydrator-386190966264.us-west1.run.app"
const PUBLIC_EXEC_ORIGIN = "https://ref-oidc-e49v5---ta-ops-analytics-7ocrxwr7lq-uw.a.run.app"
const HYDRATION_PATH = "/api/cron/recruiting-ops-staging-hydration"
const HYDRATION_SCHEDULER_ACCOUNT =
  "ta-ops-hydration-scheduler@turing-recruiting.iam.gserviceaccount.com"
const ACCEPTED_RUNTIME_RELEASE_SHA =
  "fbcae9d8d679061dd210e58e8f38bec07957d205"
const ACCEPTED_PRIVATE_IMAGE =
  "us-west1-docker.pkg.dev/turing-recruiting/recruiting/ta-ops-staging-hydrator@sha256:f379fc76c6e0ec375aa83eb9e9ed0e19bed0f09da184bc09603a1633799b573c"
const ACCEPTED_EXECUTION_FENCE = {
  count: 66,
  latestName: "ta-ops-staging-hydration-vx4hm",
  latestCreated: "2026-07-24T21:18:12.144591Z",
}
export const ACCEPTED_PUBLIC_AUTH_HEADER_SHA256 =
  "50e336af5c4829c1b7fddbfc75c7fe41d9f3fc4ba7ddbd83cfef82bba275792c"
const ACCEPTED_LOG_FENCES = {
  failureCutoff: "2026-07-24T17:30:03.399502Z",
  unifiedScheduler: {
...
const SAFE_IAM_MEMBERS = new Set([
  "allUsers",
  "serviceAccount:ta-ops-hydration-scheduler@turing-recruiting.iam.gserviceaccount.com",
  "serviceAccount:ta-ops-hydrator-run@turing-recruiting.iam.gserviceaccount.com",
  "serviceAccount:ta-ops-ref-report-scheduler@turing-recruiting.iam.gserviceaccount.com",
  "serviceAccount:ta-ops-ref-watchdog-scheduler@turing-recruiting.iam.gserviceaccount.com",
])
...
const SAFE_SERVICE_ACCOUNTS = new Set([
  "ta-ops-analytics-run@turing-recruiting.iam.gserviceaccount.com",
  "ta-ops-hydrator-run@turing-recruiting.iam.gserviceaccount.com",
])

export const ACCEPTED_BOUNDARIES = {
  privateServiceControlSha256:
    "b660f8baa91f423f916fccb1030ae7acdc4eb70927fea1dccd069cc36ea224a0",
  jobControlSha256:
    "1bbff94f6bb39995d1bf4f8b9292632de53a31122fe190a07b354f1d1d55ccb6",
  privateServiceIamSha256:
    "2c33c69ff3865a28d8f46a77aab7627f6a14232485227d94ad1a7dd74bb4c2ab",
  jobIamSha256:
    "a45f652a4787fb3531cee91f08833446aa8a8d4ac5e0d00bbd8f9e8a98434b9c",
  publicServiceControlSha256:
    "bdb0b3711c3ab38562e5431b84b5b498908164f44dfd9cb6ec81e1e4ad6260f5",
  publicServiceIamSha256:
    "a4d1caf715ff8b8b026c20a1dbd7ef50ed092f33ef4a6990d0fa5ef9d63ee258",
}
...
// Per Sam's 2026-08-06 canonical-cutover directive, the steady-state posture
...
export function normalizeSchedulers(rawSchedulers, options = {}) {
  ...
  return {
    ...
    checks: {
      ...
      // Per Sam's 2026-08-06 canonical-cutover directive, the 11 legacy
