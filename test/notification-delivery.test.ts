...
describe("enqueuePending — idempotent on dedupe_key", () => {
  ...
  // Sam 2026-08-06: the first alert must fire at DETECTION (~1h), not at the old 24h threshold.
...
describe("drain — gate ON sends and records provider_message_id", () => {
  ...
  // THE BACKLOG GUARANTEE, DRAIN SIDE (Sam 2026-08-06: "They should ONLY receive messages that
