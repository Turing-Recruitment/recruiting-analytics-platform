...
const PIPELINE_CANONICAL_ID = "1g0hCK53tJ03FgxUNNK4lizh1vUgOMWJjTg0vGWF_7M8"
const WEEKLY_PROGRESS_CANONICAL_ID = "17xg8CtSeWET-S7c1Xcoup7YJXCnn15p_O-IOmVQKuxs"
const DELIVERY_CANONICAL_ID = "1j9teESHnERTm1mmq7jDiI7qyZ3ygnzvaCbtLXdkzC3M"
const RPS_CANONICAL_ID = "1FrZlJj96-yXVdZltN3TcfLy9K_m6i_tFfrBgQGSoZEY"
const FINAL_OFFER_CANONICAL_ID = "18630K9pIfuqvIqLDN1ItC37pgs0SqZ-lmv9JQHU4uGo"
...
describe("recurring copied-sheet lifecycle runner", () => {
  ...
  test.each([
    ...
    // The CLO-131 production shape for every pipeline: the weekly tab exists,
