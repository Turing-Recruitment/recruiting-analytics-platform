...
const inboxFacts: RecruitingInboxTriageFact[] = [
  {
    ...
    draftResponse: "Thanks for the note. Sam will review and respond through the approved inbox flow.",
    ...
    expect(normalizeRecruitingInboxRows(inboxFacts)).toEqual([
      {
        ...
        owner: "Sam",
        evidence_count: 1,
        draft_response: "Thanks for the note. Sam will review and respond through the approved inbox flow.",
        human_action_required: true,
        review_required: true,
        next_gate: "Request human owner review.",
      },
