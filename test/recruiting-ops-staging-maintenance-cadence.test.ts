...
describe("canonical scheduled hydration cadence", () => {
  ...
  // Cloud Scheduler stamps whole seconds of its own delivery jitter into the
  // schedule-time header: after the first fire on 2026-08-14 arrived at :00,
  // every later fire carried 3-4 seconds (the job's stored next fire time was
  // literally 06:30:03.469627Z) and was refused as off-cadence, so no
  // scheduled run started between 2026-08-14 and 2026-08-18. The slot minute
  // is the identity; seconds inside it are transport noise.
  test.each([
    ["2026-08-19T06:30:03.469627Z", "2026-08-19T06:30:00.000Z", "weekday_evening", "2026-08-18"],
    ["2026-08-18T06:30:04-07:00", "2026-08-18T13:30:00.000Z", "weekday_morning", "2026-08-18"],
    ["2026-07-16T13:30:59Z", "2026-07-16T13:30:00.000Z", "weekday_morning", "2026-07-16"],
  ] as const)(
    "floors Scheduler whole-second jitter to the slot minute: %s",
    (scheduledAt, resolvedAt, lane, businessDate) => {
      const cycle = resolveScheduledHydrationCycle({ scheduledAt, eligibleArtifacts: ELIGIBLE_ARTIFACTS })
      expect(cycle.scheduledAt).toBe(resolvedAt)
